...
namespace CampaignProject.MicroService
{
    public static class Campaign
    {
        ...
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = "Users/{action}/{IdNumber?}")] HttpRequest req,
            string action, string IdNumber, ILogger log)
        {
            ...
            switch (action)
            {
                ...
                case "ROLE":
                    ...
                    var urlGetRole = $"https://dev-qjf7hgqeu16fymem.us.auth0.com/api/v2/users/{IdNumber}/roles";
